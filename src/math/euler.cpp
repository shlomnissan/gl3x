...
auto Euler::GetMatrix() const -> Matrix4 {
    ...
    const auto rotation_x = rotate(Matrix4{1.0f}, pitch_, Vector3::X());
    const auto rotation_y = rotate(Matrix4{1.0f}, yaw_, Vector3::Y());
    const auto rotation_z = rotate(Matrix4{1.0f}, roll_, Vector3::Z());
