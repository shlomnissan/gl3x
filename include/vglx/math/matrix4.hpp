 ...
 */
[[nodiscard]] VGLX_EXPORT inline constexpr auto Determinant(const Matrix4& m) {
    return m(0, 0) * (
 ...
 */
[[nodiscard]] VGLX_EXPORT inline constexpr auto Inverse(const Matrix4& m) {
 ...
 */
[[nodiscard]] VGLX_EXPORT inline constexpr auto Transpose(const Matrix4& m) {
    auto output = Matrix4 {};
