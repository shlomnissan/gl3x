 ...
 */
[[nodiscard]] GLEAM_EXPORT auto Determinant(const Matrix3& m) -> float;
 ...
 */
[[nodiscard]] GLEAM_EXPORT auto Inverse(const Matrix3& m) -> Matrix3;
 ...
 */
[[nodiscard]] GLEAM_EXPORT auto Transpose(const Matrix3& m) -> Matrix3;
